                ...
                if (this.AppWarp.WarpClient.instance.isConnected == true) {
                    ...
                    if (diff > this.AppWarp.WarpClient.instance.keepAliveInterval) {
                        ...
                        if (this.AppWarp.WarpClient.instance.countPendingKeepAlives > this.AppWarp.WarpClient.instance.pendingKeepAliveIntervalsLimit) {
                            this.AppWarp.WarpClient.instance.isConnected = false;
                            if (this.AppWarp.WarpClient.recoveryAllowance > 0 && this.AppWarp.WarpClient.instance.SessionID != 0) {
                                if (this.AppWarp.WarpClient.instance.responseCallbacks[this.AppWarp.Events.onConnectDone])
                                    this.AppWarp.WarpClient.instance.responseCallbacks[this.AppWarp.Events.onConnectDone](this.AppWarp.ResultCode.ConnectionErrorRecoverable);
                                this.AppWarp.WarpClient.instance.recovering = true;
                            } else if (this.AppWarp.WarpClient.instance.recovering == false) {
                                this.AppWarp.WarpClient.instance.SessionID = 0;
                                if (this.AppWarp.WarpClient.instance.responseCallbacks[this.AppWarp.Events.onConnectDone])
                                    this.AppWarp.WarpClient.instance.responseCallbacks[this.AppWarp.Events.onConnectDone](this.AppWarp.ResultCode.ConnectionError);
                            }
