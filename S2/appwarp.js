...
(function (AppWarp) {
    var RequestBuilder = (function () {
        ...
        RequestBuilder.buildAuthRequest = function (apiKey, secreteKey, user, authData) {
...
(function (AppWarp) {
    var WarpClient = (function () {
        ...
        WarpClient.prototype.joinZone = function (user, authData) {
            var payload = AppWarp.RequestBuilder.buildAuthRequest(WarpClient.apiKey, WarpClient.secretKey, user, authData);
