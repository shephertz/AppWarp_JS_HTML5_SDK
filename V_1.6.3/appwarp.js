...
(function (AppWarp) {
    (function (Events) {
        ...
        Events[Events["onUserPaused"] = 36] = "onUserPaused";
        Events[Events["onUserResumed"] = 37] = "onUserResumed";
                    ...
                    xmlHttp.onreadystatechange = function () {
                        if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                            ...
                            if (res.address) {
                                ...
                                this.connectionState = AppWarp.ConnectionState.Disconnected;
                                if (that.responseCallbacks[AppWarp.Events.onConnectDone])
                                    that.responseCallbacks[AppWarp.Events.onConnectDone](AppWarp.ResultCode.ApiNotFound, 0);
                            }
