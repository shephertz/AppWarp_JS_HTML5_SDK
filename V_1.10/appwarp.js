...
(function (AppWarp) {
    (function (Events) {
        ...
        Events[Events["onPrivateUpdateReceived"] = 33] = "onPrivateUpdateReceived";
        Events[Events["onMoveCompleted"] = 34] = "onMoveCompleted";
        Events[Events["onGameStarted"] = 35] = "onGameStarted";
        Events[Events["onGameStopped"] = 36] = "onGameStopped";
        Events[Events["onUserPaused"] = 37] = "onUserPaused";
        Events[Events["onUserResumed"] = 38] = "onUserResumed";

        Events[Events["onSendChatDone"] = 39] = "onSendChatDone";
        Events[Events["onSendPrivateChatDone"] = 40] = "onSendPrivateChatDone";
        Events[Events["onSendUpdateDone"] = 41] = "onSendUpdateDone";
        Events[Events["onSendPrivateUpdateDone"] = 42] = "onSendPrivateUpdateDone";

        Events[Events["onSendMoveDone"] = 43] = "onSendMoveDone";
        Events[Events["onStartGameDone"] = 44] = "onStartGameDone";
        Events[Events["onStopGameDone"] = 45] = "onStopGameDone";
        Events[Events["onGetMoveHistoryDone"] = 46] = "onGetMoveHistoryDone";
        Events[Events["onSetNextTurnDone"] = 47] = "onSetNextTurnDone";
        Events[Events["onNextTurnRequested"] = 48] = "onNextTurnRequested";
...
(function (AppWarp) {
    var WarpClient = (function () {
        ...
        WarpClient.prototype.sendMove = function (moveData, nextTurn) {
            if (typeof nextTurn === "undefined") { nextTurn = ""; }
            if (this.connectionState != AppWarp.ConnectionState.Connected) {
                if (this.responseCallbacks[AppWarp.Events.onSendMoveDone])
        ...
        WarpClient.prototype.startGame = function (isDefaultLogic, turnUser) {
            if (typeof isDefaultLogic === "undefined") { isDefaultLogic = true; }
            if (typeof turnUser === "undefined") { turnUser = ""; }
            if (this.connectionState != AppWarp.ConnectionState.Connected) {
                if (this.responseCallbacks[AppWarp.Events.onStartGameDone])
